# CueLoop Bridge Autodesk final-package workspace

This directory begins the December **Build the Autodesk University 2027 Product** package without conflating it with CueLoop V1 or destabilizing the September deadlines. It is a development contract, not a claim that the V2 product, PCBWay parts, Fusion Electronics, portability, or final evidence already exists.

## Artifact map

| Required V2 dimension | Working source | Evidence needed for completion |
|---|---|---|
...
| Eligibility differentiation | `../DIFFERENTIATION.md`, final audit | visibly distinct story, enclosure, hardware, interaction, testing, and media |
...
- `V2_DEVELOPMENT_PLAN.md` — scope, workstreams, milestones, decision gates, and schedule.
- `MANUFACTURING_PLAN.md` — process selection, DFM, assembly, quality, and approximately-750-unit thinking.
- `EVIDENCE_MATRIX.md` — claim-to-test traceability and evidence-tier rules.
- `FINAL_ARTICLE_OUTLINE.md` — polished final story structure and media assignments.
- `SUBMISSION_CHECKLIST.md` — December rubric/account preflight.

All future V2 artifacts must preserve the V1 safety/privacy claim boundaries and add a clear provenance/evidence label. A preliminary or rendered state never becomes a physical/manufacturing result by appearance alone.
