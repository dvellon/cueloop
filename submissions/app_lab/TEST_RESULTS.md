...
|---|---|---|---|---|
| Regression suite | Development computer / simulation | `./scripts/test.sh` | 44 tests passed at the last integrated checkpoint | Exercises software contracts; no board or real-audio claim |
