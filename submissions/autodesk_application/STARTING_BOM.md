...
Prices are manufacturer list prices rechecked September 2, 2026 and may differ by region, tax, shipping, or the entrant's invoice. “TBD after inventory/test” is deliberate; optional output hardware is not treated as essential until the Arduino packing list and power tests are available.
...
| 1 | XIAO ESP32S3 Sense | Seeed Studio 113991115 | Detachable Wi-Fi PDM microphone pod | Ordered | US$13.90, Seeed list price |
