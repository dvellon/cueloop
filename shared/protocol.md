...
V1 is intended only for a trusted private LAN. CRCs detect corruption; they do not provide authentication, integrity against an attacker, or confidentiality. Never expose the UDP port to the internet or use the prototype on public Wi-Fi.
