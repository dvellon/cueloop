...
All notable changes are recorded here. This project uses semantic versioning once the first integrated release is tagged.

## Unreleased

### Added

- Authoritative competition project brief.
- Safe ignore policy for secrets, private audio, datasets, models, build products, local databases, and generated CAD/media.
- Project control, requirements, architecture, privacy, safety, and official-requirements documentation.
- Submission-ready Autodesk application copy apart from account URL and truthful entrant biography.
- Production-intent native Autodesk Fusion API generator with 125 named parameters, constrained sketches, native features/components/history, six manufacturing components, six explicit reference envelopes, exploded placement, and F3D/STEP/STL/3MF/BOM/source-provenance exports.
- Independent FreeCAD/OpenCascade reference generator with committed editable FCStd and assembly/per-part STEP/STL files, STEP-reopen validation, exact-bounds checks, 12 zero-volume interference checks, and SHA-256 manifests.
- Dependency-free CAD source/output validator, PCBWay DFM gates, complete design provenance, and exact Windows Fusion native-history/visual-review/render/return runbook.
- Parametric CAD dimension/physical-validation checklist and provenance-labeled cover concept.
...
- Automated native Fusion/source-provenance/reference-solid/output and Autodesk-application completeness checks, plus one deadline-ordered physical/account handoff sheet.
